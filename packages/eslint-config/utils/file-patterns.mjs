...
export const typescriptFileSuffixes = [
  'ts',
  'mts',
  'cts',
...
export const typescriptTestFilePatterns = typescriptFileSuffixes
...
export const jsJSXTestFilePatterns = jsJSXFileSuffixes
  .map(ext => [`*.test.${ext}`, `*.spec.${ext}`])
  .flat();
export const typescriptJSXTestFilePattern = typescriptJSXFileSuffixes
  .map(ext => [`*.test.${ext}`, `*.spec.${ext}`])
  .flat();

...
3. [eslint-config](./packages/eslint-config-esm) [![npm version](https://badge.fury.io/js/%40busybox%2Feslint-config.svg)](https://badge.fury.io/js/%40busybox%2Feslint-config.svg)
